...
const Navbar = () => {
  ...
  const baseButtonClass =
    "px-4 py-2 text-sm rounded-full font-bold border-2 transition-all duration-300";
  ...
  return (
    <nav className="flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
      <div className="flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        <div
          id="collapseMenu"
          className={`lg:block ${menuOpen ? "block" : "hidden"} lg:!block lg:static fixed inset-0 lg:inset-auto lg:bg-transparent bg-white z-50`}
        >
          <button
            onClick={closeMenu}
          ...
          {userId ? (
            ...
            <div className="relative">
              <button
                ...
                className={`${baseButtonClass} bg-[#000] text-white border-[#000] hover:bg-transparent hover:text-[#000]`}
              >
                Profile
              </button>
              {dropdownOpen && (
